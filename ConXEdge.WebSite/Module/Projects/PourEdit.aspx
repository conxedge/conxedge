<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PourEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.PourEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pour Edit</title>
 <base target="_self" />
     ...
     $(document).ready(function () {
         ...
         $('#ddlProject').combobox({
             ...
             onLoadSuccess: function () {
                 if ($("#hdProject").val() != "") {
                     $(this).combobox("select", $("#hdProject").val());
                 }
             }
         });
         ...
         $('#ddlProduct').combobox({
             ...
             onLoadSuccess: function () {
                 if ($("#hdProduct").val() != "")
                     $(this).combobox("select", $("#hdProduct").val());
             }
         });
         ...
         $('#ddlMaturityMethod').combobox({
             ...
             onLoadSuccess: function () {
                 if ($("#hdMaturityMethod").val() != "")
                     $(this).combobox("select", $("#hdMaturityMethod").val());
             }
         });
         ...
         $('#ddlContact').combobox({
             ...
             onLoadSuccess: function () {
                if ($("#hdContact").val() != "")
                     $(this).combobox("select", $("#hdContact").val());
             }
         });
         ...
         $('#ddlStopType').combobox({
             ...
             onLoadSuccess: function () {
                if ($("#hdStopType").val() != "")
                     $(this).combobox("select", $("#hdStopType").val());
             }
        });
        ...
        $('#ddlPourType').combobox({
            ...
            onLoadSuccess: function () {
                if ($("#hdPourType").val() != "")
                    $(this).combobox("select", $("#hdPourType").val());
            }
        });
     });
