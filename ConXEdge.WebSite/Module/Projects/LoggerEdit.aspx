<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoggerEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.LoggerEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Logger Edit</title>
    <base target="_self" />
...
<body>
    ...
    <div class="p_nav" width="100%">
         <a href="LoggerList.aspx"> Logger </a> >> Logger Edit
    </div>
      <table class="t2">
        <tr>
            <th>
