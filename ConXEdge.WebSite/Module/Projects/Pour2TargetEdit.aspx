<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pour2TargetEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.Pour2TargetEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pour Target Edit</title>
    <base target="_self" />
...
<script type="text/javascript">
    ...
    function Return() {
        window.location.href = "Pour2TargetList.aspx?pid=" + $("#hfPourID").val() + "&rand=" + new Date().toString();
    }
</script>
<body>
    <form id="form1" runat="server">
    <div class="p_nav" width="100%">
         <a href="javascript:Return();">Pour</a> >> Default Pour Target Edit
    </div>
      <table class="t2">
        <tr>
