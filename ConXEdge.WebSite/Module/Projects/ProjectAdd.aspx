<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectAdd.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.ProjectAdd" %>
...
<body>
    ...
    <div class="p_nav" width="100%">
         <a href="ProjectList.aspx"> Project </a> >> Project Add
    </div>
      <table class="t2">
        <tr>
            <th>
