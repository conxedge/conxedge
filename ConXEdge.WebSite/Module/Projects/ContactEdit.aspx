<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.ContactEdit" %>
...
<body>
    ...
    <div class="p_nav" width="100%">
         <a href="ContactList.aspx"> Contact </a> >> Contact Edit
    </div>
      <table class="t2">
        <tr>
            <th>
