...
{
    public partial class PourList : ConXEdge.WebSite.AppCode.PageBase
    {
        ...
        public string GetOperation(string pid,string status)
        {
            string str = "";
            if (status == "0")
            {
                 ...
                 //str +=" &nbsp;<a href=\"javascript:SetTarget('" + pid + "');\">Set Target</a>";
                 //str +=" &nbsp;<a href=\"javascript:SetLevel('" + pid + "');\">Set Level</a>";
                 //str +=" &nbsp;<a href=\"javascript:SetLocation('" + pid + "');\">Set Location</a>";
                 str +=" &nbsp;<a href=\"javascript:Start('" + pid + "');\">Start</a>";
            }
            return str; 
        }
    }
