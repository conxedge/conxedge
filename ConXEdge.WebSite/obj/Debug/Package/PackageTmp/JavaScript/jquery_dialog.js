...
var JqueryDialog = {
	...
	init:function(dialogTitle, iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag){
		...
		if(isSubmitButton){
			_jd_dialog_m_t.append("<span><span class='btn_ba1' id='jd_submit' onclick='JqueryDialog.Ok();' > "+JqueryDialog.cSubmitText+"</span></span>");
		}
		if(isCancelButton){
			_jd_dialog_m_t.append("<span class='jd_dialog_m_t_s'><span id='jd_cancel' class='btn_ba1' onclick='JqueryDialog.Close();'>"+JqueryDialog.cCancelText+"</span></span>");
		}
