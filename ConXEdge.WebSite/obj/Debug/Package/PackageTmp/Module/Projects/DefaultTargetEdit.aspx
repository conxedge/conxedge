<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultTargetEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.DefaultTargetEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Default Target Edit</title>
    <base target="_self" />
...
<body>
    ...
    <div class="p_nav" width="100%">
         <a href="DefaultTargetList.aspx"> Target </a>>> Default Target Edit
    </div>
      <table class="t2">
        <tr>
