<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LevelEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.LevelEdit" %>
...
<body>
    ...
    <div class="p_nav" width="100%">
         <a href="LevelList.aspx"> Level </a> >> Level Edit
    </div>
      <table class="t2">
        <tr>
            <th>
