<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pour2LocationEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.Pour2LocationEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pour Location Edit</title>
 <base target="_self" />
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         ...
         $('#ddlLogger').combobox({
             ...
             onLoadSuccess: function () {
                 if ($("#hdLogger").val() != "") {
                     $(this).combobox("select", $("#hdLogger").val());
                 }
             }
         });
         ...
         $('#ddlChannelNo').combobox({
             ...
             onLoadSuccess: function () {
                 if ($("#hdChannelNo").val() != "") {
                     $(this).combobox("select", $("#hdChannelNo").val());
                 }
             }
         });
         ...
         $('#ddlMonitorType').combobox({
             ...
             onLoadSuccess: function () {
                 if ($("#hdMonitorType").val() != "") {
                     $(this).combobox("select", $("#hdMonitorType").val());
                 }
             }
         });
     });
     ...
     function LoadLoggingStart() {
         ...
         if (loggerID != "" && channelID != "") {
             ...
             $('#ddlLoggingStart').combobox({
                 ...
                 onLoadSuccess: function () {
                     if ($("#hdLoggingStart").val() != "") {
                         $(this).combobox("select", $("#hdLoggingStart").val());
                     }
                     bLoad = false;
                 }
             });
     ...
     function Return() {
         window.location.href = "Pour2LocationList.aspx?pid=" + $("#hfPourID").val() + "&rand=" + new Date().toString();
     }
    </script>
<body>
    <form id="form1" runat="server">
    <div class="p_nav" width="100%">
         <a href="javascript:Return();">Pour Location</a> >>  Pour Location Edit
    </div>
      <table class="t2">
        <tr>
