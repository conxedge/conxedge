<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductEdit.aspx.cs" 
Inherits="ConXEdge.WebSite.Module.Projects.ProductEdit" %>
...
<body>
    ...
    <div class="p_nav" width="100%">
         <a href="ProductList.aspx">Product</a> >> Product Edit
    </div>
      <table class="t2">
        <tr>
            <th>
